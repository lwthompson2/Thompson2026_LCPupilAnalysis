function stats = unitSummaryPlot_slope(LC_Beep_data, LC_Fix_data)
...
raw_p_evoked = LC_Beep_data(:,5); %Slope is just slope
corrected_p_evoked = raw_p_evoked; % same 
sub_p_evoked = LC_Beep_data(:,5); % same
